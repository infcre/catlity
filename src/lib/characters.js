...
export const characters = [
  {
    id: 'chocola',
    name: '巧克力', nameEn: 'Chocola', emoji: '🍫',
    source: '《猫娘乐园》', mbti: 'ESFP',
    x: 40, y: 35, z: -20,
  ...
  {
    id: 'vanilla',
    name: '香子兰', nameEn: 'Vanilla', emoji: '🍦',
    source: '《猫娘乐园》', mbti: 'ISTJ',
    x: -30, y: 0, z: 30,
  ...
  {
    id: 'azuki',
    name: '小红豆', nameEn: 'Azuki', emoji: '🫘',
    source: '《猫娘乐园》', mbti: 'ESTP',
    x: 25, y: -15, z: -25,
  ...
  {
    id: 'okayu',
    name: '猫又おかゆ', nameEn: 'Okayu', emoji: '🍙',
    source: 'Hololive', mbti: 'ISFP',
    x: -25, y: 25, z: -20,
    quote: '嗯……再睡五分钟就好……大概……',
  ...
  {
    id: 'hinata',
    name: '猫宫ひなた', nameEn: 'Hinata', emoji: '☀️',
    source: 'Hololive', mbti: 'ENFP',
    x: 20, y: 5, z: -5,
    quote: '大家一起唱歌吧！我来起头！',
