	...
	{:else}
		<div class="reveal">
			...
			<div class="section">
				<h3>你的性格坐标</h3>
				<div class="plot-wrap">
					<Plot3D user={scores} characters={result.rankings} />
				</div>
				<div class="plot-legend">
					...
					<span class="sep">·</span>
					<span><i class="dot" style="background:#FF9D76"></i>你</span>
					<span><i class="dot" style="background:#FFD6E0"></i>最像</span>
					<span><i class="dot" style="background:#B8E6B8"></i>第二</span>
					<span><i class="dot" style="background:#FFE9A8"></i>第三</span>
				</div>
			</div>
...
<style>
	...
	.rank {
		...
		gap: 0.5rem;
		padding: 0.6rem 0;
		border-bottom: 1px solid var(--color-bg-bar);
		font-size: 0.92rem;
	}
	.rank:last-child {
		border-bottom: none;
